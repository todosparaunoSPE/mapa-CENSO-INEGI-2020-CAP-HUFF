# -*- coding: utf-8 -*-
"""
Created on Tue Dec 19 11:22:08 2023
...
st.subheader("Ejemplo: Modelo de Huff utilizando datos de la entidad federativa de Tlaxcala")
#st.header("POBLACIÓN ECONÓMICAMENTE ACTIVA")
...
st.write("Ejemplo [link](https://todosparaunospe.github.io/57-CAPS/)")
