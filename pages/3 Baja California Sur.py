...
st.set_page_config(page_title="CENSO-2020-PEA-Baja California Sur", page_icon=":bar_chart:", layout="wide")
...
def get_data_from_excel():
    df = pd.read_excel(
        io="Baja-California-Sur.xlsx",
        engine="openpyxl",
        sheet_name="Baja California Sur",
        skiprows=3,
        usecols="B:Q",
        nrows=5,
    )
...
st.title(":bar_chart: Baja California Sur")
st.markdown("##")
...
st.write("Baja California Sur-Mapa [link](https://todosparaunospe.github.io/Baja-California-Sur-3/)")
