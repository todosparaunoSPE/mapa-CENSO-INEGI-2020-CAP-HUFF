...
st.set_page_config(page_title="CENSO-2020-PEA-Baja California", page_icon=":bar_chart:", layout="wide")
...
def get_data_from_excel():
    df = pd.read_excel(
        io="Baja-California.xlsx",
        engine="openpyxl",
        sheet_name="Baja California",
        skiprows=3,
        usecols="B:Q",
        nrows=6,
    )
...
st.title(":bar_chart: Baja California")
st.markdown("##")
...
st.write("Baja California-Mapa [link](https://todosparaunospe.github.io/Baja-California/)")
