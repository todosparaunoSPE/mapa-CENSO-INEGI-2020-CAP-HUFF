...
st.set_page_config(page_title="CENSO-2020-PEA-San-Luis-Potosi", page_icon=":bar_chart:", layout="wide")
...
def get_data_from_excel():
    df = pd.read_excel(
        io="San-Luis-Potosi.xlsx",
        engine="openpyxl",
        sheet_name="San-Luis-Potosi",
        skiprows=3,
        usecols="B:Q",
        nrows=58,
    )
...
st.title(":bar_chart: San Luis Potosí")
st.markdown("##")
...
st.write("San Luis Potosí-Mapa [link](https://todosparaunospe.github.io/San-Luis-Potosi-XIV/)")
