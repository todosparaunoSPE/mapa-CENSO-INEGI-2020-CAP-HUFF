...
st.set_page_config(page_title="CENSO-2020-PEA-Quintana-Roo", page_icon=":bar_chart:", layout="wide")
...
def get_data_from_excel():
    df = pd.read_excel(
        io="Quintana-Roo.xlsx",
        engine="openpyxl",
        sheet_name="Quintana-Roo",
        skiprows=3,
        usecols="B:Q",
        nrows=11,
    )
...
st.title(":bar_chart: Quintana Roo")
st.markdown("##")
...
st.write("Quintana Roo-Mapa [link](https://2z6f2lrzc5fegrmyunpt2q.on.drv.tw/html/Quintana%20Roo-CAP.html)")
